...
int main()
{
    ...
    // O asterisco (*) indica que 'ptr' não é uma caixa para um número, mas sim para um "endereço de um número inteiro".
    int *ptr;

    // O '&' significa "endereço de". Estamos dizendo: "ponteiro ptr, guarde o endereço da variável numero".
    ptr = &numero;

    printf("--- Informacoes Basicas ---\n");
    printf("Valor do ponteiro 'ptr' (ele guarda o endereco): %p\n\n", ptr);

    // Usamos o asterisco (*) de novo, mas agora ele significa "o valor apontado por".
